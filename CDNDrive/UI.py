...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.downloadPauseResumeButton = QtWidgets.QPushButton(self.download_tab)
        self.downloadPauseResumeButton.setGeometry(QtCore.QRect(580, 40, 200, 28))
        self.downloadPauseResumeButton.setObjectName("downloadPauseResumeButton")
        self.downloadStopButton = QtWidgets.QPushButton(self.download_tab)
        self.downloadStopButton.setGeometry(QtCore.QRect(580, 70, 200, 28))
        self.downloadStopButton.setObjectName("downloadStopButton")
        self.clearInputButton = QtWidgets.QPushButton(self.download_tab)
        self.clearInputButton.setGeometry(QtCore.QRect(580, 100, 200, 28))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.downloadPauseResumeButton.setText(_translate("Stop", "暂停"))
        self.downloadStopButton.setText(_translate("Stop", "停止"))
